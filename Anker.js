...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN: JayDarkNet\n'
            + 'ORG:Owner JAY BOT;\n'
            + 'TEL;type=CELL;type=VOICE;waid=628993801551:628993801551\n'
            + 'END:VCARD'

prefix = "!"
name = "~ J A Y  | B O T"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN JAYBOT😁"
rmenu = "HAI TEMEN JAYBOT👋 JANGAN LUPA DONASI YAA:)"
limitt = 10
ban = []
...
async function starts() {
	...
	fs.existsSync('./jay.json') && client.loadAuthInfo('./jay.json')
	...
	await client.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./jay.json', JSON.stringify(client.base64EncodedAuthInfo(), null, '\t'))
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const JayGans = ["08993801551@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["628993801551@s.whatsapp.net"] // owner number ubah aja
				...
				default:
                  ...
                  reply(`Maaf Kak, Command *${prefix}${command}* Tidak Terdaftar Di Dalam Database *${prefix}menu*`)
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[JAYBOT]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
